<div class="panel panel-danger">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            <label class="control-label" for="date">{{trans('study_material.date_on')}}</label>
            <div class="controls">
                @if (isset($studyMaterial)) {{ $studyMaterial->date_on }} @endif
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="controls">
                @if (isset($studyMaterial))
                    <a class="btn btn-xs btn-info" href="{{ url($type.'/'.$studyMaterial->id.'/download') }}">
                        {{$studyMaterial->file}}</a>
                @endif
            </div>
        </div>
        <div class="form-group">
