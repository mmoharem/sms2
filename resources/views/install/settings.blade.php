...
@section('content')
    ...
    <div class="step-content" style="padding-left: 15px; padding-top: 15px">
        ...
        <div class="form-group {{ $errors->has('gender') ? 'has-error' : '' }}">
            {!! Form::label('gender', trans('install.gender'), array('class' => 'control-label required')) !!}
            <div class="controls radiobutton">
                {!! Form::label('gender', trans('install.female'), array('class' => 'control-label')) !!}
                {!! Form::radio('gender', '0', false) !!}
                {!! Form::label('gender', trans('install.male'), array('class' => 'control-label')) !!}
