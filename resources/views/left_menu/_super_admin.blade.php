...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
        ...
        <ul class="nav side-menu metismenu" id="menu">
            ...
            {{-- .................start options.............. --}}
            <h2 class="menu-title text-center">Optins1</h2>
            
            
            <li class="menu-item-has-children dropdown ">
                <a href="# " class="dropdown-toggle " data-toggle="dropdown " aria-haspopup="true
                    " aria-expanded="false "> <i class="menu-icon fa fa-laptop "></i>Initial</a>
            ...
            <li class="menu-item-has-children dropdown ">
                <a href="# " class="dropdown-toggle " data-toggle="dropdown " aria-haspopup="true
                    " aria-expanded="false "> <i class="menu-icon fa fa-table "></i>Grade System</a>
                <ul class="sub-menu children dropdown-menu ">
                 ...
                 {{-- .................end options.............. --}}
                {{-- ......................start of.Accounts........... --}}
                <h2 class="menu-title text-primary text-center">User Accounts</h2>

                {{-- ..............stuff.............. --}}
                <li class="menu-item-has-children dropdown ">
                    <a href="# " class="dropdown-toggle " data-toggle="dropdown " aria-haspopup="true
                        " aria-expanded="false "> <i class="menu-icon fa fa-table "></i>Staff</a>
                    <ul class="sub-menu children dropdown-menu ">
                    ...
                    <li class="menu-item-has-children dropdown ">
                        <a href="# " class="dropdown-toggle " data-toggle="dropdown " aria-haspopup="true
                        " aria-expanded="false "> <i class="menu-icon fa fa-table "></i>Accounts Log</a>
                        <ul class="sub-menu children dropdown-menu ">
                            <li {!! (starts_with(Route::current()->uri, 'login_history') ? '{{--class="active
                        " id="active "--}}' : '') !!}>
                                <i class="fa fa-sign-in "></i>
                                <a href="{{url( '/login_history')}} ">{{ trans('left_menu.login_history') }}</a>
                            </li>   
                ...
                {{-- ......................end of .Accounts........... --}}
                        {{-- .......................................start Of pages................ --}}
                    <h2 class="menu-title text-info text-center">Pages</h2>
                    <!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown ">
                    <a href="# " class="dropdown-toggle " data-toggle="dropdown " aria-haspopup="true
                    ...
                    {{-- .......................................End of blog................ --}}
                    {{-- .......................................start of settings................ --}}
                    <h2 class="menu-title text-info text-center">Settings</h2>
                    <!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown ">
                    <a href="# " class="dropdown-toggle " data-toggle="dropdown " aria-haspopup="true
                        " aria-expanded="false "> <i class="menu-icon fa fa-glass "></i>Pages</a>
                    ...
                    {{-- .......................................start of Others................ --}}
                    <h2 class="menu-title text-info text-center">Other</h2>
                    <!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown ">
                    <a href="# " class="dropdown-toggle " data-toggle="dropdown " aria-haspopup="true
                        " aria-expanded="false "> <i class="menu-icon fa fa-glass "></i>Pages</a>
